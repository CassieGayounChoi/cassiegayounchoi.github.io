---
pagetitle: "Machine Learning/Data Science"
output:
  html_document:
    toc: true
    toc_depth: 5
...
Please click [HERE](https://nbviewer.org/github/CassieGayounChoi/cassiegayounchoi.github.io/blob/main/files/Predicting_CLV_using_regression_and_ML.ipynb) for the analysis report and code.
